...
class ItemClothes extends StatefulWidget {
  const ItemClothes({Key? key}) : super(key: key);
              ...
              Stack(
                children: [
                  Container(
                    ...
                    child:  Image(
                      image: AssetImage(clothesModel[index].imgPath),
                      height: 150,
                      width: 150,
                    ),
                  ),
