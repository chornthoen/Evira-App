...
import '../model/watch_models.dart';

class ItemWatch extends StatefulWidget {
  const ItemWatch({Key? key}) : super(key: key);

  @override
  State<ItemWatch> createState() => _ItemWatchState();
}
              ...
              Stack(
                children: [
                  Container(
                    ...
                    child:  Image(
                      image: AssetImage(watchModel[index].imgPath),
                      height: 150,
                      width: 150,
                    ),
                  ),
